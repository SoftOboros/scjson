"""
Agent Name: activation-module

Part of the scjson project.
Developed by Softoboros Technology Inc.
Licensed under the BSD 1-Clause License.

Runtime activation records and transition specifications.
"""
...
class ActivationStatus(str, Enum):
    """Lifecycle state for an activation."""
...
class ActivationRecord(BaseModel):
    ...
    def mark_final(self) -> None:
        """Mark this activation as final and propagate upwards."""
    ...
    def path(self) -> List["ActivationRecord"]:
        """Return the path from the root activation to ``self``."""
