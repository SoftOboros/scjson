...
Python is set up with all modules specified. Do not run pip or poetry.

## JavaScript Configuration
The package.json for the js directory specifies dist/index.js as the entry point. Therefore, the package needs to be compiled with 'npm run build' prior to execution via node or testing after changes with uber_test.py.
...
- Docstrings for classes and functions including doxygen style params / returns.
...
- **Notes**:
  - Can be used independently or as a pre-flight step
