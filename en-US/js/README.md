 ...
 *
 * @backend/istate/tests/data/SCXML-tutorial/Doc/param.md {string} xmlStr - XML input.
 * @backend/istate/tests/data/SCXML-tutorial/Doc/param.md {boolean} [omitEmpty=true] - Remove empty values when true.
 ...
 *
 * @backend/istate/tests/data/SCXML-tutorial/Doc/param.md {string} jsonStr - JSON input.
...
Enums use this pattern to allow all static and dynamic portions to be treated separately,
...
- `AssignProps` `AssignArray`         – update a datamodel location with an an expression or value.
