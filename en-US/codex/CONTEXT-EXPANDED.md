...
- Compare traces versus reference (leaf-only + step-0 normalization):
...
Uber harness (cross-language conversion)
...
- Initialization visibility varies across engines; step-0 normalization mitigates differences
